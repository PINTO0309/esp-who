...
static dl::detect::Detect *get_detect_model()
{
    return new uhd_detect::UltraLightweightHumanDetect();
}

static void run_detect_lcd()
{
    ...
    // auto frame_cap = get_lcd_uvc_frame_cap_pipeline(&lcd_disp_frame_cap_node);
#endif
